...
l.readyState=l.DONE,q(l),g(r)}()},e=d.prototype;if("undefined"!==typeof navigator&&navigator.msSaveOrOpenBlob)return function(a,b,c){b=b||a.name||"download";c||(a=m(a));return navigator.msSaveOrOpenBlob(a,b)};e.abort=function(){};e.readyState=e.INIT=0;e.WRITING=1;e.DONE=2;e.error=e.onwritestart=e.onprogress=e.onwrite=e.onabort=e.onerror=e.onwriteend=null;return function(a,b,c){return new d(a,b||a.name||"download",c)}}}(n);if(n.o10n)var w=n.o10n.prototype;else n.o10n=new v,w=v.prototype;w.extract=
function(b,h){if("full"===b){var f=x();console.clear&&console.clear();console.log("%cFull CSS Extraction","font-size:24px;font-weight:bold");console.groupCollapsed&&console.groupCollapsed("Extracted Full CSS ("+t(f.length)+")");console.log(f);console.groupCollapsed&&console.groupEnd();f="/**\n * Full CSS\n *\n * @url "+document.location.href+"\n * @title "+document.title+"\n * @size "+t(f.length)+"\n *\n * Extracted using Critical CSS Widget.\n * @link https://github.com/o10n-x/critical-css-widget\n */\n\n"+
