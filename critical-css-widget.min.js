...
!1}).join(" "):!1;try{a.matches(f)&&e.push(h[n])}catch(d){}}}return e}var g=[];g=function(a){function c(a,e){return e.filter(function(e){return e.c===a})}var e=[];a.forEach(function(a){a.forEach(function(a){var h=a.selectorText;var f=c(h,e);h=0<f.length?f[0]:{c:h,f:{}};for(f=0;f<a.style.length;f++){var d=a.style[f];h.f[d]=a.style.getPropertyValue(d)}0===c(h.c,e).length&&e.push(h)})});return e}(a([document.body]));return g.reduce(function(a,g){a+=g.c+" {\n";a+=Object.keys(g.f).reduce(function(a,c){a.push("  "+
c+": "+g.f[c]+";");return a},[]).join("\n");return a+"\n}\n"},"")}function y(a,b,g){function c(a){var h=a.parentStyleSheet.href;h||(k++,h="inline");!1===!!e[h]&&(e[h]={media:a.parentStyleSheet.media,a:{}});!1===!!e[h].a[a.selectorText]&&(e[h].a[a.selectorText]={});for(var f=a.style.cssText.split(/;(?![A-Za-z0-9])/),d=0;d<f.length;d++)if(!1!==!!f[d]){var c=f[d].split(": ");c[0]=c[0].trim();c[1]=c[1].trim();e[h].a[a.selectorText][c[0]]=c[1]}}var m=g||{},e={},k=0;this.h=function(){var a="",c=console&&
...
d[h],f instanceof CSSStyleRule&&a(b,f.selectorText)&&c.push(f)}}}return c}return function(){return k.getMatchedCSSRules?k.getMatchedCSSRules:b}}(k),this);var u=u||function(a){if(!("undefined"===typeof a||"undefined"!==typeof navigator&&/MSIE [1-9]\./.test(navigator.userAgent))){var b=a.document.createElementNS("http://www.w3.org/1999/xhtml","a"),g="download"in b,c=/constructor/i.test(a.HTMLElement)||a.g,k=/CriOS\/[\d]+/.test(navigator.userAgent),e=function(d){(a.setImmediate||a.setTimeout)(function(){throw d;
...
l.INIT}else p||(p=(a.URL||a.webkitURL||a).createObjectURL(d)),r?a.location.href=p:a.open(p,"_blank")||(a.location.href=p),l.readyState=l.DONE,n(),q(p)})()},f=n.prototype;if("undefined"!==typeof navigator&&navigator.msSaveOrOpenBlob)return function(a,b,c){b=b||a.name||"download";c||(a=h(a));return navigator.msSaveOrOpenBlob(a,b)};f.abort=function(){};f.readyState=f.INIT=0;f.b=1;f.DONE=2;f.error=f.m=f.i=f.j=f.onabort=f.g=f.l=null;return function(a,b,c){return new n(a,b||a.name||"download",c)}}}(k);
if(k.b)var w=k.b.constructor.prototype;else k.b=new v,w=v.prototype;w.extract=function(a,b){if("full"===a){a=x();var g=!0;console.clear&&console.clear();console.log("%cFull CSS Extraction","font-size:24px;font-weight:bold");console.groupCollapsed&&console.groupCollapsed("Extracted Full CSS ("+t(a.length)+")");console.log(a);console.groupCollapsed&&console.groupEnd();g?(a="/**\n * Full CSS\n *\n * @url "+document.location.href+"\n * @title "+document.title+"\n * @size "+t(a.length)+"\n *\n * Extracted using Critical CSS Widget.\n * @link https://github.com/critical-x/critical-css-widget\n */\n\n"+
a,b?b(a):(b=new Blob([a],{type:"text/css;charset=utf-8"}),a=(a=k.location.pathname)&&"/"!==a&&-1!==a.indexOf("/")?"-"+a.replace(/\/$/,"").split("/").pop():"-front-page",u(b,"full-css"+a+".css"))):alert("Your browser does not support javascript based file download. The full CSS is printed in the console.")}else{g=(new y(k,document)).h();a=g[0];g=g[1];var c="/**\n * Simple Critical CSS\n *\n * @url "+document.location.href+"\n * @title "+document.title+"\n * @viewport "+k.innerWidth+"x"+k.innerHeight+
"\n * @size "+t(a.length)+"\n *\n * Extracted using Critical CSS Widget.\n * @link https://github.com/critical-x/critical-css-widget\n *\n * For professional Critical CSS generators see https://github.com/addyosmani/critical-path-css-tools\n *\n * @sources",m=c.split(/\r\n|\r|\n/).length;m+=g.length+3;for(var e=0;e<g.length;e++)c+="\n * @line "+(g[e][1]+m)+"\t @file "+g[e][0];c=c+"\n */\n\n"+a;b?b(c):(b=new Blob([c],{type:"text/css;charset=utf-8"}),a=(a=k.location.pathname)&&"/"!==a&&-1!==a.indexOf("/")?
"-"+a.replace(/\/$/,"").split("/").pop():"-front-page",u(b,"critical-css"+a+".css"))}return"Starting extract..."}})(window);
