...
The tool also provides a PostCSS based unused CSS remover that can automatically remove the Critical CSS so that duplicate CSS is removed from the main stylesheets.
